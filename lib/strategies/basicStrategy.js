  ...
  function (callback) {
    ...
    for (var i = 0; i < seriesLength; i++) {
      ...
      if (currentState != previousState) {
        ...
        var orderObj = createTradeOrderObjFromState(A_B, currentState, tradeTimestamp);
        var timestampIndex = findTickByTimestamp(exports.candlestickData, tradeTimestamp);
        Portfolio.modifiyPosition(A_B, orderObj.quantity, orderObj.timestamp);
        console.log(Portfolio);

        Portfolio.updatePortfolioValue(A_B, orderObj.price /*, exports.candlestickData[timestampIndex].close*/);
