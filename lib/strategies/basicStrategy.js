...
var numDays = 90 * secsPerDay;
var startDate = currentDate - numDays;
var period = 7200; // valid values: 300, 900, 1800, 7200, 14400, 86400
var currencyA = "USDT";
var currencyB = "BTC";
  ...
  function (callback) {
    ...
    for (var i = 0; i < seriesLength; i++) {
      ...
      if (currentState != previousState) {
        ...
        Portfolio.modifiyPosition2(order, marketData);
    ...
    var backtest = Portfolio.calculateHistoricalPerformance(marketData, A_B, 'blah');
